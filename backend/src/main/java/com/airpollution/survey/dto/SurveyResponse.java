...
public record SurveyResponse(
        ...
        List<String> primaryCookingFuel,
        List<String> woodCoalCookingLocation,
        Boolean hasChildren,
        ...
        String cancerType,
        Boolean worriedAboutAirPollution,
        List<String> airPollutionConcerns,
        String otherAirPollutionConcern,
